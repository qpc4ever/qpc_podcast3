...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { description: @podcast.description, name: @podcast.name, upload_date: @podcast.upload_date } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { description: @podcast.description, name: @podcast.name, upload_date: @podcast.upload_date } }
